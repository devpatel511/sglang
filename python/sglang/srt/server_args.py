...
class ServerArgs:
    ...
    def _handle_moe_runner_backend_alias(self):
        ...
        self._declare(
            "_handle_moe_runner_backend_alias",
    ...
    def _handle_model_specific_adjustments(self):
        ...
        if parse_connector_type(self.model_path) == ConnectorType.INSTANCE:
            # No model overrides for an instance connector -- there is no
            # hf_config to key them on. Earlier handlers have already declared,
            # so the stash keeps what it holds.
            return
    ...
    def _handle_a2a_moe(self):
        ...
        # moved this already (waterfill forces `deepep`), and testing the raw
        # value would declare `none` on top of it -- which is how routing this
        # write into the stash silently changed which writer wins.
